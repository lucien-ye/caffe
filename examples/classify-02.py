...
with open(osp.join(workdir, 'trainnet.prototxt'), 'w') as f:
    ...
    data_layer_params = dict(batch_size = 28, im_shape = [227, 227], split = 'train', pascal_root = pascal_root)
    f.write(caffenet_multilabel(data_layer_params, 'PascalMultilabelDataLayerSync'))

# write validation net.
with open(osp.join(workdir, 'valnet.prototxt'), 'w') as f:
    data_layer_params = dict(batch_size = 28, im_shape = [227, 227], split = 'val', pascal_root = pascal_root)
    f.write(caffenet_multilabel(data_layer_params, 'PascalMultilabelDataLayerSync'))
...
def check_accuracy(net, num_batches, batch_size = 28):
    acc = 0.0
...
# def check_baseline_accuracy(net, num_batches, batch_size = 28):
#     acc = 0.0
#     for t in range(num_batches):
#         net.forward()
#         gts = net.blobs['label'].data
...
# print 'Baseline accuracy:{0:.4f}'.format(check_baseline_accuracy(solver.test_nets[0], 5823/28))
